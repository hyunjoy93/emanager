...
public class StringUtil {
    ...
    public static String isNullToString(Object object, String str) {
        String string = isNullToString(object);
    ...
    public static int zeroConvert(Object src) {
    	return zeroConvert(src, 0);
    }
    public static int zeroConvert(Object src, int defaultValue) {
    ...
    public static int zeroConvert(String src, int defaultValue) {
